...
class ProcessedTeamStatsDf(models.Model):
    ...
    total_gold_for_game = models.FloatField(blank=True, null=True)
    ...
    csum_min_minions_killed = models.FloatField(blank=True, null=True)
    csum_prev_min_minions_killed = models.FloatField(blank=True, null=True)
    csum_total_gold = models.FloatField(blank=True, null=True)
    csum_total_total_gold = models.FloatField(blank=True, null=True)
    csum_prev_total_gold = models.FloatField(blank=True, null=True)
    csum_total_prev_total_gold = models.FloatField(blank=True, null=True)
    csum_prev_avg_total_gold = models.FloatField(blank=True, null=True)
    per_min_total_gold = models.FloatField(blank=True, null=True)
    csum_prev_percent_total_gold = models.FloatField(blank=True, null=True)
    margin_total_gold = models.FloatField(blank=True, null=True)
    eff_total_gold = models.FloatField(blank=True, null=True)
    csum_min_total_gold = models.FloatField(blank=True, null=True)
    csum_prev_min_total_gold = models.FloatField(blank=True, null=True)
